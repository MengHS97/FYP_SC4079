...
class CarliniL0:
    ...
    def gradient_descent(self, sess, model):
        ...
        set_modifier = modifier.assign(assign_modifier)
        setup = []
        setup.append(canchange.assign(assign_canchange))
        setup.append(timg.assign(assign_timg))
        setup.append(original.assign(assign_original))
        setup.append(simg.assign(assign_simg))
    ...
    def attack_single(self, img, target):
        ...
        while True:
            ...
            if res is None:
                ...
                return [img]  # Return the original image or an empty list
